...
from graph_algorithms import d_degeneracy_ordering, get_degree_distribution, triangle_counting
def graph_algorithm_tests():
	print('\ntesting graph algorithms\n')

	graph = requirements.Graph(5, {(0, 1), (0,3), (1,2), (2,3), (3, 4)})
	# print(graph.is_adjacent(0, 1))
	# print(graph.is_adjacent(0, 3))
	# print(graph.is_adjacent(1, 2))
	# print(graph.is_adjacent(2, 3))
	# print(graph.is_adjacent(3,4))
	# print("\n")
	# print(graph.is_adjacent(0,2))
	# print(graph.is_adjacent(1,3))
	# print(graph.is_adjacent(1,4))
	# print(graph.is_adjacent(0,4))
	# print(graph.is_adjacent(2,4))
	# print("\n")

	# graph = requirements.Graph(5, {(0, 1), (0,2), (0,3), (0,4), })
	# graph = requirements.Graph(4, {(0, 3), (1, 3), (1, 2), (2, 3), })
