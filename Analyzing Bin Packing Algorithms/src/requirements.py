...
# Rank is a container representing each node's rank, both (on ed disscussion) geometric (0 & 1, 50% each) and uniform (randomly choose from 0 to log(capacity)^3 - 1 (log capacity cubed minus 1)).
